...
function zh_tranBody(obj) {
	...
	for(var i = 0; i < o.length; i++) {
		var c = o.item(i);
		//		var languagetype = o[i].getAttribute("languagetype")
		if(typeof obj != "undefined" && obj.getAttribute("languagetype") == "no") {
			continue;
		}
...
//			}
			...
			window.localStorage.setItem("languageType", 1) //默认简体中文
			//			zh_getLang("s");
		}
