    ...
    methods: {
        ...
        clearAllBuyCar() {
            ...
            self.$confirm('确认清空选号车吗?', '提示', {
                ...
                .then(() => {
                    self.$http
                        .post(self.API.removeAllAccountCarAPI, {
        ...
        deleteBuyCar(item) {
            ...
            self.$confirm('确认删除吗?', '提示', {
                ...
                .then(() => {
                    self.$http
                        .post(self.API.removeAccountCarAPI, {
                            platformId: self.platformId,
                            accountId: item.id
                        })
                        .then(
        ...
        changeAdType(item) {
            let self = this;
            self.$http
                .post(self.API.editAccountCarAPI, {
                    platformId: self.platformId,
                    adType: item.adType,
                    accountId: item.id
                })
        ...
        addAccountCarList() {
            let self = this;
            self.$http
                .get(self.API.addAccountCarListAPI, {
                    params: {
                        platformId: self.platformId
                    }
                })
        ...
        comfig() {
            ...
            self.$http
                .post(
                    self.yytfParams.type == 1 ? self.API.addAccountAPI : self.API.addAccountCarAPI,
                    self.yytfParams
                )
                .then(
                    response => {
        ...
        addWechatList() {
            ...
            self.$http
                .get(self.API.talentListAPI + str.join(''), {
                    params: {
        ...
        addPlatform() {
            ...
            //				12 微信   13微博  14 小红书
            self.$http
                .get(self.API.subPlatformListAPI, {
                    params: {
                        pid: 4
                    }
                })
        ...
        .item {
            ...
            .right {
                ...
                .delete {
                    ...
                    height: 32px;
                    cursor: pointer;
                    background: url(../../../static/icon/guanggaozhu/clear.png) no-repeat center
                        center;
